...
public enum ErrorCode {
    ...
    LEARNING_PATH_INVALID(40030, "学习路径内容不符合约束", HttpStatus.BAD_REQUEST),
    LEARNING_PATH_ACCESS_DENIED(40330, "无权访问该学习路径", HttpStatus.FORBIDDEN),
    ...
    AI_PROVIDER_UNAVAILABLE(50311, "AI服务暂时不可用", HttpStatus.SERVICE_UNAVAILABLE),
    AI_RESPONSE_EMPTY(50210, "AI返回内容为空", HttpStatus.BAD_GATEWAY),
    AI_RESPONSE_INVALID(50211, "AI返回内容不符合计划约束", HttpStatus.BAD_GATEWAY),
