...
public class StudyPlanController {
    ...
    @PostMapping("/{planId}/items/{itemId}/complete") public ApiResponse<PlanDetailView> completeItem(@PathVariable long planId,@PathVariable long itemId,@Valid @RequestBody PlanItemCompleteRequest r){return ApiResponse.success(service.completeItem(planId,itemId,r));}
