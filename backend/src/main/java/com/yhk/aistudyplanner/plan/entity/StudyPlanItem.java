...
public class StudyPlanItem {
    ...
    private Integer actualMinutes; private String feedback; private TaskStatus taskStatusBeforeCompletion;
    private LocalDateTime taskCompletedAt; private String reason; private PlanItemStatus status;
    ...
    public Integer getActualMinutes(){return actualMinutes;} public void setActualMinutes(Integer v){actualMinutes=v;}
    public String getFeedback(){return feedback;} public void setFeedback(String v){feedback=v;}
    public TaskStatus getTaskStatusBeforeCompletion(){return taskStatusBeforeCompletion;} public void setTaskStatusBeforeCompletion(TaskStatus v){taskStatusBeforeCompletion=v;}
    public LocalDateTime getTaskCompletedAt(){return taskCompletedAt;} public void setTaskCompletedAt(LocalDateTime v){taskCompletedAt=v;}
