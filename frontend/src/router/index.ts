  ...
  routes: [
    {
      ...
      children: [
        ...
        { path: 'plans', name: 'plans', component: () => import('../views/plans/PlanView.vue'), meta: { title: '每日计划', description: '把今天的学习需求整理成可执行时间安排' } },
        { path: 'learning-paths', name: 'learning-paths', component: () => import('../views/learning-paths/LearningPathView.vue'), meta: { title: '学习路径', description: '从长期目标规划阶段、知识点与学习方法' } },
